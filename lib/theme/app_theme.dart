...
class AppTheme {
  ...
  // Agricultural color palette - Natural Professional Palette
  ...
  static const Color accentLight = Color(0xFFFF8F00); // Warm amber for alerts
  static const Color backgroundLight = Color(0xFFFAFAFA); // Soft off-white
  static const Color surfaceLight = Color(0xFFFFFFFF); // Pure white
  static const Color errorLight =
      Color(0xFFD32F2F); // Clear red for critical alerts
  static const Color warningLight =
      Color(0xFFF57C00); // Orange for weather warnings
  ...
  // Shadow colors (minimal for clean aesthetics)
  ...
  // Text colors with agricultural context
  static const Color textPrimaryLight =
      Color(0xFF212121); // High contrast for outdoor use
  static const Color textSecondaryLight =
      Color(0xFF757575); // Medium gray for hierarchy
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      elevation: 2.0, // Subtle elevation for clean hierarchy
    ...
    cardTheme: CardTheme(
      color: cardLight,
      elevation: 2.0, // Material elevation system
      shadowColor: shadowLight,
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(8.0), // Contemporary feel
      ),
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      // Title styles - Poppins for key information
      ...
      // Body styles - Inter for mobile reading optimization
